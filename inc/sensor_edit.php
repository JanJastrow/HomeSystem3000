...
<form method="POST" action="?site=sensor_edit&function=save_settings&sensor_id=<? echo $sensor_id ?>">
    <table class="sensors">
        <tbody>
        <?php
        ...
        <tr>
            <td>Einheit:</td>
            <td><input name="sensor_unit" type="text" value="<? echo $sensor_unit ?>" /></td>
        </tr>
        <tr>
            <td>Name:</td>
            <td><input name="sensor_name" type="text" value="<? echo $sensor_name ?>" /></td>
        </tr>
        <tr>
            <td>Hardware-ID:</td>
            <td><input name="sensor_hardware_id" type="text" value="<? echo $sensor_hardware_id ?>" /></td>
        </tr>
        <tr>
            <td>Beschreibung:</td>
            <td><input name="sensor_description" type="text" value="<? echo $sensor_description ?>" /></td>
        </tr>
        <tr>
            <td>Gruppe:</td>
            <td>
        ...
        <tr>
            <td>Linien-Farbe:</td>
            <td><input name="sensor_html_color" type="text" value="<? echo $sensor_html_color  ?>" class="colorpicker"/></td>
        </tr>
        <tr>
            <td>Symbol:</td>
            <td>
                <select name="sensor_symbol">
                    <option value="circle" <? if($sensor_symbol == "circle") { echo "selected"; } ?>>Kreis</option>
                    <option value="cross" <? if($sensor_symbol == "cross") { echo "selected"; } ?>>Kreuz</option>
                    <option value="triangle" <? if($sensor_symbol == "triangle") { echo "selected"; } ?>>Dreieck</option>
                </select>
            </td>
        </tr>
        <tr>
            <td>maximum Wert:</td>
            <td><input name="sensor_max_value" type="number" value="<? echo $sensor_max_value ?>" /></td>
        </tr>
        <tr>
            <td>Warnungs-Wert:</td>
            <td><input name="sensor_warning_value" type="number" value="<? echo $sensor_warning_value ?>" /></td>
        </tr>
        <tr>
            <td>minimum Wert:</td>
            <td><input name="sensor_min_value" type="number" value="<? echo $sensor_min_value ?>" /></td>
        </tr>
        <tr>
            <td>Benachrichtigungen:</td>
            <td>
                <select name="sensor_notification_status">
                <option value="1" <? if($sensor_notification == "1") { echo "selected"; } ?>>Aktiv</option>
                <option value="0" <? if($sensor_notification == "0") { echo "selected"; } ?>>Inaktiv</option>
                </select>
            </td>
        </tr>
        <tr>
...
elseif($site_function == "change_status")
{
    ...
    mysqli_close($con); 
?>
<h1>Der Sensor wurde <? echo $sensor_mode_changed ?>.</h1>
